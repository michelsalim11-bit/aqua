...
export const metadata: Metadata = {
  ...
  description:
    'Princípios que orientam a atuação de todos que fazem parte da Seja Acqua — sócios, administradores, prestadores de serviços e fornecedores.',
  alternates: { canonical: '/codigo-de-etica-e-conduta' },
  openGraph: {
    ...
    <>
      <section className="page-hero">
        <div className="wrap reveal">
          ...
          <p>
            Princípios que orientam a atuação de todos que fazem parte da Seja Acqua — sócios,
            administradores, prestadores de serviços e fornecedores.
          </p>
        </div>
      </section>
      ...
      <section className="band">
        <div className="wrap">
          <article className="prose-legal" style={{ maxWidth: '760px' }}>
            ...
            <p>
              Cada Credenciado deve, sem prejuízo das demais disposições contidas nesse Código de Ética e Conduta:
            </p>
            <ul>
              ...
              <li>Adotar condutas compatíveis com os princípios de idoneidade;</li>
              <li>
                Cumprir todas as suas obrigações, devendo, no exercício de suas atividades, empregar o cuidado que
                toda pessoa prudente e diligente costuma dispensar à administração de seus próprios negócios,
            ...
            <h3>1. Conhecimento da legislação</h3>
            <p>
              Os Credenciados devem entender e estar em conformidade com todas as leis, regras e regulamentos
              vigentes emitidos por governo, órgãos reguladores, órgãos de licenciamento ou associações que possam
              influenciar suas atividades. Em caso de conflitos provenientes de leis, regras ou regulamentos, os
              Credenciados devem trazer o tema ao conhecimento da Diretoria de Compliance e cumprir as exigências
              que se façam necessárias. Não admitimos condutas de inadequação regulatória.
            </p>
            <h3>2. Independência e objetividade</h3>
            <p>
            ...
            <p>
              Realizamos orientações constantes e procedimentos de vigília para evitar e identificar condutas
              inadequadas pelos Credenciados. Os mesmos são instruídos para que não se envolvam em condutas erradas,
            ...
            <h2>B. Deveres em relação aos clientes</h2>
            <h3>1. Lealdade, prudência e tratamento justo</h3>
            <p>
              Os Credenciados possuem dever de lealdade para com os clientes, com atuação pautada em transparência,
              cautela e discernimento. Os interesses dos clientes são prioridade. Todos devem ser tratados sob os
              princípios de ética, justiça e respeito, sempre.
            </p>
            <h3>2. Confidencialidade</h3>
            <p>
              Os Credenciados mantêm a confidencialidade de todos os dados e informações das pessoas do nosso
              relacionamento (incluindo prospects, clientes ativos e inativos), seguindo as diretrizes da LGPD (Lei
              nº 13.709/2018) e demais afins:
            </p>
            <ol>
              <li>Atividades com suspeita de ilicitude são devidamente investigadas e reportadas aos órgãos responsáveis;</li>
              <li>A divulgação de informações será realizada na forma definida pelas legislações pertinentes;</li>
              <li>
            ...
            <p>
              ...
              necessário, para que haja atendimento com plenitude das capacidades e habilidades típicas da nossa
              cultura.
            </p>
            <h3>2. Ética</h3>
            <p>
            ...
            <h2>D. Conflitos de interesse</h2>
            <h3>1. Direcionamento de conflitos</h3>
            <p>
            ...
            <h3>1. Equidade</h3>
            <p>
              Todos os seres humanos com quem nos relacionamos são merecedores de respeito, educação, cordialidade,
              acolhida e entendimento. Nossa cultura proíbe expressamente toda e qualquer forma de discriminação de
              qualquer ordem, incluindo origem racial ou étnica, convicção religiosa, opinião política, filiação a
              sindicato ou a organização de caráter religioso, filosófico ou político, dado referente à saúde ou à
              vida sexual, quando vinculado a uma pessoa natural. Não toleramos situações ou ambientes de assédio.
            </p>
