...
const DESCRIPTION =
  'Documentos que orientam a relação entre a Seja Acqua, seus clientes, parceiros e visitantes.';
...
const docs = [
  {
    title: 'Termos de Uso',
    text: 'Condições de utilização da plataforma e dos canais digitais da Seja Acqua.',
    href: '/termos-de-uso',
    icon: (
  ...
  },
  {
    ...
    text: 'Princípios que orientam a atuação da Seja Acqua e o relacionamento com clientes, parceiros e colaboradores.',
    ...
    <>
      <section className="page-hero">
        <div className="wrap reveal">
          ...
          <p>
            Aqui você encontra os documentos que orientam a relação entre a Seja Acqua, seus clientes,
