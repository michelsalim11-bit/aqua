    ...
    return (
      ...
      >
        ...
        <p className="max-w-xs text-[15px] leading-relaxed text-[var(--muted)]">
          Um especialista da Aqua vai falar com você em breve. Enquanto isso, o movimento continua.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <p className="mt-1.5 text-sm leading-relaxed text-[var(--muted)]">
        Preencha e fale com um especialista da Aqua. Sem custo e sem compromisso.
      </p>
      ...
      <p className="mt-4 text-center text-xs leading-relaxed text-[var(--faint)]">
        Ao continuar, você concorda em ser contatado pela Aqua. Seus dados estão protegidos.
      </p>
    </form>
  );
}
